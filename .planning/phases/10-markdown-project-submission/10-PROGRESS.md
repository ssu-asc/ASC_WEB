...
- [x] Least-privilege `PROJECTDB_TOKEN` provisioned in hosted Supabase
- [ ] First real approval/publish observation — retained as an operator smoke, not a v1.0 implementation blocker
